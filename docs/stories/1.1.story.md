...
- **Frontend:** React Native 0.73+, TypeScript 5.3+, Zustand 4.5+, Expo 50+
- **Backend:** FastAPI 0.109+, Python 3.11+, SQLAlchemy async ORM, Pydantic 2.5+
- **Database:** PostgreSQL 15+ with JSONB support
- **Cache:** Redis 7.2+ for conversation context and session state
- **Monorepo:** Nx 18+ for build orchestration and caching
